      ...
      <div className="max-w-5xl mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-12 relative z-10">
        ...
        <header className="mb-12 sm:mb-16 text-center">
          ...
          <div className="flex justify-center gap-3 sm:gap-4 animate-fadeInUp delay-400 mb-6 sm:mb-8">
            ...
            <a href="https://github.com/gauravtayade" target="_blank" rel="noopener noreferrer" className="bg-white/5 backdrop-blur-md border border-white/10 rounded-full p-3 hover:bg-white/10 hover:border-purple-400 transition-all hover:scale-110 group">
            ...
            <a href="https://twitter.com/gauravtayade" target="_blank" rel="noopener noreferrer" className="bg-white/5 backdrop-blur-md border border-white/10 rounded-full p-3 hover:bg-white/10 hover:border-blue-400 transition-all hover:scale-110 group">
              ...
              const allCertifications = [
                {
                  ...
                  url: "https://www.credly.com/badges/your-aws-developer-badge-id"
                },
                {
                  ...
                  url: "https://www.credential.net/your-gcp-credential-id"
                },
                {
                  ...
                  textColor: "text-orange-400",
                  bgGlow: "group-hover:shadow-orange-500/20",
                  url: "https://www.credly.com/badges/your-aws-practitioner-badge-id"
                },
                {
                  ...
                  textColor: "text-blue-400",
                  bgGlow: "group-hover:shadow-blue-500/20",
                  url: "https://learn.microsoft.com/en-us/users/your-microsoft-id/credentials/your-cert-id"
                },
              ];
