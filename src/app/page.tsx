      ...
      <div className="max-w-5xl mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-12 relative z-10">
        ...
        <header className="mb-12 sm:mb-16 text-center">
          ...
          <div className="flex justify-center gap-3 sm:gap-4 animate-fadeInUp delay-400 mb-6 sm:mb-8">
            ...
            <a href="https://github.com/gauravtayade11" targe="_blank" rel="noopener noreferrer" className="bg-white/5 backdrop-blur-md border border-white/10 rounded-full p-3 hover:bg-white/10 hover:border-purple-400 transition-all hover:scale-110 group">
